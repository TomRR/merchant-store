...
using MerchantStoreApi.Settings;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MerchantStoreApi v1"));
            }
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                // checks if db is ready to take request
                ...
                // checks if the service is up and running - service = api
